...
eXist-db requires Java SE 1.8, and if you do not have this, you will need to download and install it first: <http://www.oracle.com/technetwork/java/javase/downloads/index.html>. If you aren’t sure whether you have Java (or the right version of Java) installed, follow the instructions at <https://www.java.com/en/download/help/version_manual.xml> to check.
...
** Thanks to David J. Birnbaum and the organizers of the NEH Institute, Make *your* edition: models and methods for digital textual scholarship, held in Pittsburgh, PA  July 2017 for permission to adapt this introduction to XQuery from their course material. 